            ...
            products: [
                {
                    ...
                    description: "A beautifully crafted minimalist ceramic vase perfect for adding elegance to any room. Hand-finished with a smooth matte texture.",
                    features: ["Handmade ceramic", "Matte finish", "Water resistant", "Easy to clean", "Modern design"]
                },
                {
                    id: 2,
                    name: "Crossbody Bag",
                    ...
                    description: "Stylish and practical leather crossbody bag with adjustable strap. Perfect for daily use with multiple compartments for organization.",
                    features: ["Genuine leather", "Adjustable strap", "Multiple pockets", "Zippered closure", "Compact design"]
                },
                {
                    id: 3,
                    name: "Throw Blanket",
                    ...
                    description: "Cozy wool blend throw blanket that adds warmth and style to your living space. Soft texture perfect for all seasons.",
                    features: ["Wool blend fabric", "Extra soft", "Machine washable", "Lightweight", "Versatile use"]
                },
                {
                    id: 4,
                    name: "Coffee Mug Set",
                ...
                },
                {
                    ...
                    description: "Elegant linen cushion cover with hidden zipper closure. Breathable fabric that adds a touch of sophistication to any space.",
                    features: ["100% linen", "Hidden zipper", "Breathable fabric", "45cm x 45cm", "Easy to wash"]
                },
                {
                    id: 8,
                    ...
                    description: "Modern ceramic plant pot with drainage hole and saucer. Perfect for indoor plants with a sleek minimalist design.",
                    features: ["Ceramic material", "Drainage hole included", "Comes with saucer", "UV resistant glaze", "Multiple sizes"]
                },
                {
                    id: 9,
                    name: "Storage Basket",
                ...
                },
                {
                    ...
                    description: "Complete porcelain dinner plate set for 4 people. Elegant white finish suitable for both casual and formal dining.",
                    features: ["Service for 4", "Porcelain material", "Microwave safe", "Dishwasher safe", "Chip resistant"]
                },
                {
                    id: 11,
                    ...
                    description: "Premium leather-bound journal with thick cream paper. Perfect for writing, sketching, or planning with a classic aesthetic.",
                    features: ["Genuine leather cover", "200 pages", "Ribbon bookmark", "Elastic closure", "Acid-free paper"]
                },
                {
                    id: 12,
                    name: "Coaster Set",
